  ...
  return;
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            ...
            {currentUser && isHistoryModalOpen && <AnalysisHistoryModal isOpen={isHistoryModalOpen} onClose={() => setIsHistoryModalOpen(false)} user={currentUser} onHistoryUpdate={handleHistoryUpdate} onUserUpdate={updateUserState} />}
                                ...
                                {showProfileDropdown && (
                                     <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 origin-top-right">
                                        <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                            ...
                                            <button onClick={handleHistoryClick} className="w-full text-left block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                                                Analysis History
                                            </button>
