...
import { AnalysisResult, ChatMessage, User, GroundingSource, AnalysisInputType, Restaurant, AnalysisHistoryEntry } from './types';
...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            ...
            {currentUser && isHistoryModalOpen && <AnalysisHistoryModal isOpen={isHistoryModalOpen} onClose={() => setIsHistoryModalOpen(false)} user={currentUser} onHistoryUpdate={handleHistoryUpdate} />}
